...
When using pattern-based anonymization, anon can detect potential approximate matches and report warnings. This is off by default; enable it with `check_approximate = TRUE` or globally with `options(anon.check_approximate = TRUE)`.
